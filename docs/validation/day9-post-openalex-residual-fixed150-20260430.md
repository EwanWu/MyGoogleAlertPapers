...
- output_db: `/home/ewan/NewCareer/Openclaw/proj/MyGoogleAlertPapers/data/benchmark/day9_post_openalex_residual_fixed150_20260430.db`
...
- provider_intent_count: `678`
- source_record_count: `678`
...
- total_batch_duration_ms: `22685`
- total_provider_latency_ms: `704022`
- cost_event_count: `1413`
- batch_run_count: `3`
- paid_llm_usage_present: `False`
- paid_llm_note: `No paid LLM call path was exercised in this replay run.`
- dispatch_request_count: `411`
...
- request_savings_vs_processed_intents: `344`
- request_savings_vs_total_planned_intents: `344`
...
- title_lane_request_count: `264`
- title_lane_group_counts_by_reason: `{'identifier_present_but_not_sufficient_for_provider_path': 280, 'cluster_leader_path': 60}`
- title_lane_request_counts_by_reason: `{'identifier_present_but_not_sufficient_for_provider_path': 204, 'cluster_leader_path': 60}`
- title_lane_group_counts_by_provider: `{'openalex': 170, 'crossref': 170}`
- title_lane_request_counts_by_provider: `{'openalex': 170, 'crossref': 94}`
...
- title_lane_request_counts_by_provider_reason: `{'openalex': {'identifier_present_but_not_sufficient_for_provider_path': 140, 'cluster_leader_path': 30}, 'crossref': {'identifier_present_but_not_sufficient_for_provider_path': 64, 'cluster_leader_path': 30}}`
- title_lane_identifier_gap_group_counts_by_subreason: `{'url_canonical_only': 252, 'mixed_non_doi_identifier': 28}`
- title_lane_identifier_gap_request_counts_by_subreason: `{'url_canonical_only': 176, 'mixed_non_doi_identifier': 28}`
...
- title_lane_identifier_gap_request_counts_by_provider_subreason: `{'openalex': {'url_canonical_only': 126, 'mixed_non_doi_identifier': 14}, 'crossref': {'url_canonical_only': 50, 'mixed_non_doi_identifier': 14}}`
...
- post_openalex_suppressed_group_count: `76`
- post_openalex_suppressed_group_counts_by_provider: `{'crossref': 76}`
- post_openalex_suppressed_group_counts_by_title_subreason: `{'url_canonical_only': 76}`
- post_openalex_unsuppressed_targeted_group_count: `50`
- post_openalex_unsuppressed_targeted_group_counts_by_reason: `{'openalex_title_unmatched': 50}`
- post_openalex_unsuppressed_targeted_group_counts_by_title_subreason: `{'url_canonical_only': 50}`
- title_lane_post_prelink_residual_group_count: `340`
- title_lane_post_prelink_residual_request_count: `264`

## Provider summary
- arxiv: events=9, total_latency_ms=10507, estimated_cost_usd=0.000000
- crossref: events=291, total_latency_ms=391016, estimated_cost_usd=0.000000
- europepmc: events=5, total_latency_ms=6298, estimated_cost_usd=0.000000
...
- pubmed: events=5, total_latency_ms=4415, estimated_cost_usd=0.000000
