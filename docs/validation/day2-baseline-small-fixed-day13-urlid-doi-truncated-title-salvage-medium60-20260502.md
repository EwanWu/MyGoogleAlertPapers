...
- output_db: `/home/ewan/NewCareer/Openclaw/proj/MyGoogleAlertPapers/data/benchmark/day2_baseline_small-fixed_day13-urlid-doi-truncated-title-salvage-medium60-20260502.db`
...
- total_batch_duration_ms: `158993`
- total_provider_latency_ms: `156185`
- cost_event_count: `224`
- batch_run_count: `3`
- paid_llm_usage_present: `False`
- paid_llm_note: `No paid LLM call path was exercised in this replay run.`
- dispatch_request_count: `72`
...
- request_savings_vs_processed_intents: `50`
- request_savings_vs_total_planned_intents: `50`
...
- title_lane_request_count: `50`
- title_lane_group_counts_by_reason: `{'identifier_present_but_not_sufficient_for_provider_path': 58, 'cluster_leader_path': 8}`
- title_lane_request_counts_by_reason: `{'identifier_present_but_not_sufficient_for_provider_path': 42, 'cluster_leader_path': 8}`
- title_lane_group_counts_by_provider: `{'openalex': 33, 'crossref': 33}`
- title_lane_request_counts_by_provider: `{'openalex': 33, 'crossref': 17}`
...
- title_lane_request_counts_by_provider_reason: `{'openalex': {'identifier_present_but_not_sufficient_for_provider_path': 29, 'cluster_leader_path': 4}, 'crossref': {'identifier_present_but_not_sufficient_for_provider_path': 13, 'cluster_leader_path': 4}}`
- title_lane_identifier_gap_group_counts_by_subreason: `{'url_canonical_only': 52, 'mixed_non_doi_identifier': 6}`
- title_lane_identifier_gap_request_counts_by_subreason: `{'url_canonical_only': 36, 'mixed_non_doi_identifier': 6}`
...
- title_lane_identifier_gap_request_counts_by_provider_subreason: `{'openalex': {'url_canonical_only': 26, 'mixed_non_doi_identifier': 3}, 'crossref': {'url_canonical_only': 10, 'mixed_non_doi_identifier': 3}}`
...
- post_openalex_suppressed_group_count: `16`
- post_openalex_suppressed_group_counts_by_provider: `{'crossref': 16}`
- post_openalex_suppressed_group_counts_by_title_subreason: `{'url_canonical_only': 16}`
- post_openalex_unsuppressed_targeted_group_count: `10`
- post_openalex_unsuppressed_targeted_group_counts_by_reason: `{'openalex_title_unmatched': 10}`
- post_openalex_unsuppressed_targeted_group_counts_by_title_subreason: `{'url_canonical_only': 10}`
- title_lane_post_prelink_residual_group_count: `66`
- title_lane_post_prelink_residual_request_count: `50`

## Provider summary
- crossref: events=44, total_latency_ms=86956, estimated_cost_usd=0.000000
- europepmc: events=1, total_latency_ms=1858, estimated_cost_usd=0.000000
- none: events=118, total_latency_ms=0, estimated_cost_usd=0.000000
- openalex: events=60, total_latency_ms=66220, estimated_cost_usd=0.000000
- pubmed: events=1, total_latency_ms=1151, estimated_cost_usd=0.000000
