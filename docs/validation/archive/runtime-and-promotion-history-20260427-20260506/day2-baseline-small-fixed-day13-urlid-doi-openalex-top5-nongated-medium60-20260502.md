...
- output_db: `/home/ewan/NewCareer/Openclaw/proj/MyGoogleAlertPapers/data/benchmark/day2_baseline_small-fixed_day13-urlid-doi-openalex-top5-nongated-medium60-20260502.db`
...
- total_batch_duration_ms: `133010`
- total_provider_latency_ms: `130648`
- cost_event_count: `225`
- batch_run_count: `3`
...
- title_lane_request_count: `51`
- title_lane_group_counts_by_reason: `{'identifier_present_but_not_sufficient_for_provider_path': 58, 'cluster_leader_path': 8}`
- title_lane_request_counts_by_reason: `{'identifier_present_but_not_sufficient_for_provider_path': 43, 'cluster_leader_path': 8}`
- title_lane_group_counts_by_provider: `{'openalex': 33, 'crossref': 33}`
- title_lane_request_counts_by_provider: `{'openalex': 33, 'crossref': 18}`
...
- title_lane_request_counts_by_provider_reason: `{'openalex': {'identifier_present_but_not_sufficient_for_provider_path': 29, 'cluster_leader_path': 4}, 'crossref': {'identifier_present_but_not_sufficient_for_provider_path': 14, 'cluster_leader_path': 4}}`
- title_lane_identifier_gap_group_counts_by_subreason: `{'url_canonical_only': 52, 'mixed_non_doi_identifier': 6}`
- title_lane_identifier_gap_request_counts_by_subreason: `{'url_canonical_only': 37, 'mixed_non_doi_identifier': 6}`
...
- title_lane_identifier_gap_request_counts_by_provider_subreason: `{'openalex': {'url_canonical_only': 26, 'mixed_non_doi_identifier': 3}, 'crossref': {'url_canonical_only': 11, 'mixed_non_doi_identifier': 3}}`
...
- title_lane_post_prelink_residual_request_count: `51`

## Provider summary
- crossref: events=45, total_latency_ms=54262, estimated_cost_usd=0.000000
- europepmc: events=1, total_latency_ms=1812, estimated_cost_usd=0.000000
- none: events=118, total_latency_ms=0, estimated_cost_usd=0.000000
- openalex: events=60, total_latency_ms=72854, estimated_cost_usd=0.000000
- pubmed: events=1, total_latency_ms=1720, estimated_cost_usd=0.000000
