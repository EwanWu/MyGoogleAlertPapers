...
- output_db: `/home/ewan/NewCareer/Openclaw/proj/MyGoogleAlertPapers/data/benchmark/day14_openalex_repo_shadow_large_fixed_20260503.db`
...
- provider_intent_count: `675`
- source_record_count: `675`
- matched_source_record_count: `533`
...
- total_batch_duration_ms: `645200`
- total_provider_latency_ms: `634458`
- cost_event_count: `1400`
- batch_run_count: `3`
- paid_llm_usage_present: `False`
- paid_llm_note: `No paid LLM call path was exercised in this replay run.`
- dispatch_request_count: `408`
...
- request_savings_vs_processed_intents: `347`
- request_savings_vs_total_planned_intents: `347`
...
- title_lane_request_count: `261`
- title_lane_group_counts_by_reason: `{'identifier_present_but_not_sufficient_for_provider_path': 280, 'cluster_leader_path': 60}`
- title_lane_request_counts_by_reason: `{'identifier_present_but_not_sufficient_for_provider_path': 201, 'cluster_leader_path': 60}`
- title_lane_group_counts_by_provider: `{'openalex': 170, 'crossref': 170}`
- title_lane_request_counts_by_provider: `{'openalex': 170, 'crossref': 91}`
...
- title_lane_request_counts_by_provider_reason: `{'openalex': {'identifier_present_but_not_sufficient_for_provider_path': 140, 'cluster_leader_path': 30}, 'crossref': {'identifier_present_but_not_sufficient_for_provider_path': 61, 'cluster_leader_path': 30}}`
- title_lane_identifier_gap_group_counts_by_subreason: `{'url_canonical_only': 252, 'mixed_non_doi_identifier': 28}`
- title_lane_identifier_gap_request_counts_by_subreason: `{'url_canonical_only': 173, 'mixed_non_doi_identifier': 28}`
...
- title_lane_identifier_gap_request_counts_by_provider_subreason: `{'openalex': {'url_canonical_only': 126, 'mixed_non_doi_identifier': 14}, 'crossref': {'url_canonical_only': 47, 'mixed_non_doi_identifier': 14}}`
...
- post_openalex_suppressed_group_count: `79`
- post_openalex_suppressed_group_counts_by_provider: `{'crossref': 79}`
- post_openalex_suppressed_group_counts_by_title_subreason: `{'url_canonical_only': 79}`
- post_openalex_unsuppressed_targeted_group_count: `47`
- post_openalex_unsuppressed_targeted_group_counts_by_reason: `{'openalex_title_unmatched': 47}`
- post_openalex_unsuppressed_targeted_group_counts_by_title_subreason: `{'url_canonical_only': 47}`
- title_lane_post_prelink_residual_group_count: `340`
- title_lane_post_prelink_residual_request_count: `261`

## Provider summary
- arxiv: events=9, total_latency_ms=75679, estimated_cost_usd=0.000000
- crossref: events=288, total_latency_ms=273573, estimated_cost_usd=0.000000
- europepmc: events=5, total_latency_ms=7270, estimated_cost_usd=0.000000
- none: events=725, total_latency_ms=0, estimated_cost_usd=0.000000
- openalex: events=368, total_latency_ms=272521, estimated_cost_usd=0.000000
- pubmed: events=5, total_latency_ms=5415, estimated_cost_usd=0.000000
