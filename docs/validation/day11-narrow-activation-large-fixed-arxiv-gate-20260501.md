...
- output_db: `/home/ewan/NewCareer/Openclaw/proj/MyGoogleAlertPapers/data/benchmark/day11_narrow_activation_large_fixed_arxiv_gate_20260501.db`
...
- provider_intent_count: `708`
- source_record_count: `708`
...
- total_batch_duration_ms: `5986056`
- total_provider_latency_ms: `5976007`
- cost_event_count: `1443`
- batch_run_count: `3`
- paid_llm_usage_present: `False`
- paid_llm_note: `No paid LLM call path was exercised in this replay run.`
- dispatch_request_count: `441`
...
- request_savings_vs_processed_intents: `314`
- request_savings_vs_total_planned_intents: `314`
...
- title_lane_request_count: `294`
- title_lane_group_counts_by_reason: `{'identifier_present_but_not_sufficient_for_provider_path': 280, 'cluster_leader_path': 60}`
- title_lane_request_counts_by_reason: `{'identifier_present_but_not_sufficient_for_provider_path': 234, 'cluster_leader_path': 60}`
- title_lane_group_counts_by_provider: `{'openalex': 170, 'crossref': 170}`
- title_lane_request_counts_by_provider: `{'openalex': 170, 'crossref': 124}`
...
- title_lane_request_counts_by_provider_reason: `{'openalex': {'identifier_present_but_not_sufficient_for_provider_path': 140, 'cluster_leader_path': 30}, 'crossref': {'identifier_present_but_not_sufficient_for_provider_path': 94, 'cluster_leader_path': 30}}`
- title_lane_identifier_gap_group_counts_by_subreason: `{'url_canonical_only': 252, 'mixed_non_doi_identifier': 28}`
- title_lane_identifier_gap_request_counts_by_subreason: `{'url_canonical_only': 206, 'mixed_non_doi_identifier': 28}`
...
- title_lane_identifier_gap_request_counts_by_provider_subreason: `{'openalex': {'url_canonical_only': 126, 'mixed_non_doi_identifier': 14}, 'crossref': {'url_canonical_only': 80, 'mixed_non_doi_identifier': 14}}`
...
- post_openalex_unsuppressed_targeted_group_count: `80`
- post_openalex_unsuppressed_targeted_group_counts_by_reason: `{'openalex_title_unmatched': 80}`
- post_openalex_unsuppressed_targeted_group_counts_by_title_subreason: `{'url_canonical_only': 80}`
- title_lane_post_prelink_residual_group_count: `340`
- title_lane_post_prelink_residual_request_count: `294`

## Provider summary
- arxiv: events=9, total_latency_ms=15413, estimated_cost_usd=0.000000
- crossref: events=321, total_latency_ms=456059, estimated_cost_usd=0.000000
- europepmc: events=5, total_latency_ms=6919, estimated_cost_usd=0.000000
- none: events=735, total_latency_ms=0, estimated_cost_usd=0.000000
- openalex: events=368, total_latency_ms=5490984, estimated_cost_usd=0.000000
- pubmed: events=5, total_latency_ms=6632, estimated_cost_usd=0.000000
