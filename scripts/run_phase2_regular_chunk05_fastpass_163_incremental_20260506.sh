...
STATE="$ROOT/data/task_state/phase2_regular_chunk05_163_incremental_20260506.json"
LOG="$ROOT/data/logs/phase2_regular_chunk05_fastpass_163_incremental_20260506.log"
REVIEW_EXPORT="$ROOT/data/exports/review_queue_phase2_regular_chunk05_20260506.jsonl"
...
on_error() {
  ...
  update_state "failed" "$STEP" "inspect $LOG and the state file before retrying chunk05 regular fast-pass" || true
...
echo "[$(date --iso-8601=seconds)] Phase 2 regular chunk05 fast-pass start"
echo "ROOT=$ROOT"
...
STEP="reporting"
update_state "running" "$STEP" "phase2 regular chunk05 fast-pass complete"
...
STEP="phase2-regular-chunk05-fastpass-complete"
update_state "completed" "$STEP" "decide whether to continue chunk06 regular fast-pass or start the dedicated slow title-lane residual sweep"
echo "[$(date --iso-8601=seconds)] Phase 2 regular chunk05 fast-pass completed"
