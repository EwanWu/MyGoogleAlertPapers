...
def test_build_baseline_manifest_uses_current_mainline_profile_and_standard_outputs(tmp_path: Path):
    ...
    assert manifest['policy_profile'].endswith('config/policy_profiles/conditional_sources_v2_author_blob_fallback_only.yaml')
