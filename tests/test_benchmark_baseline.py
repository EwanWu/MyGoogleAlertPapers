...
def test_build_baseline_manifest_uses_current_runtime_default_profile_and_standard_outputs(tmp_path: Path):
    ...
    assert manifest['policy_profile'].endswith('config/policy_profiles/openalex_batching_identifier_plus_title_core_same_batch_cluster_post_openalex_skip_crossref_url_only_openalex_top5_url_only_arxiv_gate_targeted_nonarxiv_reject71_review08.yaml')
