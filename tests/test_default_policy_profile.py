...
def test_builtin_default_policy_profile_promotes_identifier_plus_title_core_same_batch_cluster_runtime():
    profile = _default_policy_profile()

    assert profile.name == 'builtin_identifier_plus_title_core_same_batch_cluster_default'
